  ...
  return (
    <RevealOnScroll delay={(index % 4) * 0.06} className="group relative flex w-full max-w-[290px]">
      ...
      <article
        ...
        className="flex h-full w-full flex-col overflow-hidden rounded-[24px] border border-white/[0.05] bg-[#0A0A0A]/40 backdrop-blur-md p-3 transition-all duration-500 hover:border-white/[0.12] hover:bg-[#0A0A0A]/75 cursor-pointer focus:outline-none focus:ring-2 focus:ring-violet-500/50"
      >
        ...
        <div className="flex flex-1 flex-col px-2.5 py-4">
          ...
          <div className="mt-1 flex items-center gap-1.5 font-sans text-[12px] font-medium text-text-secondary tracking-wide">
            ...
            {(member.level || member.experience?.label) && (
              <>
